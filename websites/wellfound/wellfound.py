...
def main_menu():
    print("\n" + "=" * 80)
    print("Wellfound Job Scraper (Browser Extension Mode)")
    print("=" * 80)
    print("\nPlease choose an option:")
    print("  1. Start Bridge Server (Connect with Chrome Extension - Port 5002)")
    ...
    while True:
        try:
            ...
            if choice == "q":
                ...
                print("\n" + "=" * 80)
                print("🚀 Bridge Server Starting... (Listening on http://127.0.0.1:5002)")
